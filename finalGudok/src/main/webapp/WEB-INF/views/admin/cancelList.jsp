    ...
    <jsp:include page="../common/adminMenubar.jsp"/>
        <div class="content">
            <div class="container box">
                ...
                <div>
                    <div style="width:50%; float:left; height:250px; background-color:lightsteelblue" id="calcelChart">교환 비율 차트</div>
                    <div style="width:50%; padding-left:50px; padding-right:30px; padding-bottom:10px; float:left;height:300px;">
                        ...
                        <table>
                            <tr>
                                <td  onclick='event.cancelBubble=true'>상품 불필요</td>
  ...
  <path d="M12.14 8.753l-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
      ...
      function drawChart() {
       ...
       var five=${list[4].temp2};
        ...
        // 입력값을 화면에 뿌려줌
        var chart = new google.visualization.PieChart(document.getElementById('calcelChart'));
